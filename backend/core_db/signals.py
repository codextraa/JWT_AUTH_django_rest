...
def save_user_slug(sender, instance, created, **kwargs): # pylint: disable=unused-argument
...
@receiver(post_save, sender=User)
def save_user_last_failed_login_time(sender, instance, created, **kwargs): # pylint: disable=unused-argument
    if created:
...
@receiver(post_save, sender=User)
def set_user_default_group(sender, instance, created, **kwargs): # pylint: disable=unused-argument
