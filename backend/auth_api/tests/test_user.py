...
class PrivateUserApiDeleteTests(APITestCase):
    ...
    def test_cannot_delete_active_user(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response.data["error"], "You must deactivate the user before deleting it.")
    ...
    def test_superuser_can_delete_deactivated_user(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data["success"], f"User {self.deactivated_user.email} deleted successfully.")
    ...
    def test_profile_image_deleted_on_user_delete(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data["success"], f"User {self.normal_user.email} deleted successfully.")
        ...
        self.assertFalse(os.path.exists(image_path), "Profile image should be deleted after user deletion")
...
class PrivateUserDeactivationTests(APITestCase):
    ...
    def test_normal_user_cannot_deactivate_other_users(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
        self.assertEqual(response.data["error"], "You do not have permission to deactivate users.")
    ...
    def test_superuser_cannot_deactivate_themselves(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
        self.assertEqual(response.data["error"], "You cannot deactivate yourself as a superuser.")
    ...
    def test_staff_cannot_deactivate_themselves(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
        self.assertEqual(response.data["error"], "You cannot deactivate yourself as a staff. Contact a superuser")
    ...
    def test_staff_cannot_deactivate_another_staff(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
        self.assertEqual(response.data["error"], "Only superusers can deactivate staff users.")
    ...
    def test_superuser_can_deactivate_a_normal_user(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data["success"], f"User {self.normal_user.email} has been deactivated.")
...
class PrivateUserActivationTests(APITestCase):
    ...
    def test_staff_cannot_activate_another_staff(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
        self.assertEqual(response.data["error"], "Only superusers can activate staff users.")
    ...
    def test_superuser_can_activate_a_normal_user(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data["success"], f"User {self.normal_user.email} has been reactivated.")
...
class PrivateUserApiImageTests(APITestCase):
    ...
    def tearDown(self):
        ...
        if user.profile_img and user.profile_img.name != "profile_images/default_profile.jpg":
    ...
    def test_upload_valid_image(self):
        ...
        response = self.client.patch(self.upload_url, {"profile_img": self.image}, format="multipart")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertIn("success", response.data)
    ...
    def test_upload_invalid_file_type(self):
        ...
        response = self.client.patch(self.upload_url, {"profile_img": invalid_file}, format="multipart")
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertIn('Profile image type should be JPEG, PNG', response.data["profile_img"]["type"])
    ...
    def test_user_cannot_upload_for_other_users(self):
        ...
        response = self.client.patch(upload_url, {"profile_img": self.image}, format="multipart")
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
        self.assertIn("error", response.data)
        self.assertIn("You do not have permission to upload an image for this user.", json.dumps(response.data['error']))
