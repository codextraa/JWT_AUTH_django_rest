...
class LoginView(APIView):
    ...
    @extend_schema(
        summary="Login to get an OTP or JWT Tokens",
        description=(
        ...
        responses={
            status.HTTP_200_OK: OpenApiResponse(
                response=PolymorphicProxySerializer(
                    ...
                    serializers=[OTPResponseSerializer, TokenResponseSerializer],
        ...
        examples=[
            ...
            OpenApiExample(
                ...
                value={
                    ...
                    "access_token_expiry": "2026-06-17T12:34:56.789Z",
                    "user_id": 42,
                    "user_role": "Default",
...
class TwoFAView(APIView):
    ...
    @method_decorator(csrf_protect)
    def post(self, request, *args, **kwargs):  # pylint: disable=R0911, R0914
        """Post a request to TwoFA. Returns JWTTokens to the registered email."""
        try:
...
class SocialLoginView(APIView):
    ...
    @method_decorator(csrf_protect)
    def post(self, request, *args, **kwargs):  # pylint: disable=R0914
        """Post a request to social login. Returns JWTTokens to the registered email."""
        try:
